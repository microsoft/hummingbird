...
if sys.platform == "win32":
    if sys.version_info[:2] == (3, 5):
        DEPENDENCY_LINKS = ["torch @ https://download.pytorch.org/whl/cpu/torch-1.5.0%2Bcpu-cp35-cp35m-win_amd64.whl"]
    elif sys.version_info[:2] == (3, 6):
        DEPENDENCY_LINKS = ["torch @ https://download.pytorch.org/whl/cpu/torch-1.5.0%2Bcpu-cp36-cp36m-win_amd64.whl"]
    elif sys.version_info[:2] >= (3, 7):
        DEPENDENCY_LINKS = ["torch @ https://download.pytorch.org/whl/cpu/torch-1.5.0%2Bcpu-cp37-cp37m-win_amd64.whl"]
    elif sys.version_info[:2] >= (3, 8):
        DEPENDENCY_LINKS = ["torch @ https://download.pytorch.org/whl/cpu/torch-1.5.0%2Bcpu-cp38-cp38-win_amd64.whl"]
    else:
