...
class PyTorchBackendModel(torch.nn.Module):
    ...
    def __init__(self, input_names, output_names, operator_map, topology, extra_config):
        """
        :param input_names: The names of the input variables for this model
        :param output_names: The names of the output variables generated by this model
        :param operator_map: A dictionary of operator aliases and related PyTorch implementations
        :param topology: The abstract operator graph
        :param extra_config: Some additional custom configuration parameter
        """
