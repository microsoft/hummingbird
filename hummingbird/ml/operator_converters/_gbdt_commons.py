...
def convert_gbdt_classifier_common(tree_infos, get_tree_parameters, n_features, n_classes, classes=None, missing_val=None, extra_config={}):
    """
    ...
    return convert_gbdt_common(tree_infos, get_tree_parameters, n_features, classes, missing_val, extra_config)


def convert_gbdt_common(tree_infos, get_tree_parameters, n_features, classes=None, missing_val=None, extra_config={}):
    """
    ...
    if tree_type == TreeImpl.gemm:
        return GEMMGBDTImpl(net_parameters, n_features, classes, missing_val, extra_config)
    if tree_type == TreeImpl.tree_trav:
        return TreeTraversalGBDTImpl(net_parameters, max_depth, n_features, classes, missing_val, extra_config)
    else:  # Remaining possible case: tree_type == TreeImpl.perf_tree_trav.
        return PerfectTreeTraversalGBDTImpl(net_parameters, max_depth, n_features, classes, missing_val, extra_config)
